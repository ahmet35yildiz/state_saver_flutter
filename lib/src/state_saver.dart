...
class StateSaver with WidgetsBindingObserver {
  ...
  /// Adding static methods to allow usage like StateSaver.clearAllStates()
  ...
  /// Adding static methods to allow usage like StateSaver.load(key)
  ...
  /// Adding static methods to allow usage like StateSaver.clear(key)
  static Future<bool> clear(String key) async {
    return await _instance.clearState(key);
  }

  /// Adding static methods to allow usage like StateSaver.clearAll()
